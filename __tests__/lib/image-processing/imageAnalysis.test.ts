...
// Static import - Jest should intercept this
import sharp from "sharp";

// Use a variable to hold the mock implementation, accessible within the module scope
const sharpImplementation = sharp as jest.MockedFunction<typeof sharp>;
          ...
          > => {
            if (options?.resolveWithObject) {
              ...
              return Promise.resolve({
                ...
                info: { channels: hasAlpha ? 2 : 1 } as import("sharp").OutputInfo,
              });
            }
