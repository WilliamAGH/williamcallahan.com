...
export const TAG_ONTOLOGY = {
  ...
  AI_CONCEPTS: [
    ...
    "openai", "gpt", "llm", "claude", "gemini", "anthropic",
    "neural networks", "deep learning", "nlp", "natural language processing",
    "ai development tools", "ai agents", "rag", "embeddings",
    "transformers", "generative ai", "predictive analytics"
  ],
  
  // Venture Capital and Investing
  VENTURE_CONCEPTS: [
    "venture capital", "vc", "investing", "investment", "startups",
    "series a", "series b", "series c", "seed", "seed+", "pre-seed",
    "funding", "fundraising", "portfolio", "angel investing",
    "accelerator", "incubator", "techstars", "y combinator",
    "investment platforms", "venture", "capital", "equity"
  ],
  
  // Web Development Technologies
  WEB_TECH: [
    "react", "nextjs", "next.js", "vue", "angular", "svelte",
    "javascript", "typescript", "html", "css", "tailwind", "tailwind css",
    "frontend", "web app", "spa", "pwa", "web development",
    "responsive design", "ui/ux", "web components", "jsx", "tsx"
  ],
  ...
  BACKEND_TECH: [
    ...
    "microservices", "serverless", "lambda", "edge functions"
  ],
  
  // Databases and Storage
  DATA_STORAGE: [
    "database", "sql", "nosql", "postgresql", "postgres", "mysql",
    "mongodb", "redis", "elasticsearch", "dynamodb",
    "s3", "object storage", "cache", "caching", "data persistence",
  ...
  DEVOPS: [
    ...
    "deployment", "hosting", "cloud", "aws", "gcp", "azure",
    "vercel", "netlify", "railway", "fly.io", "heroku",
    "infrastructure", "terraform", "ansible", "monitoring"
  ],
  
  // Finance and Fintech
  FINANCE: [
    "finance", "fintech", "payments", "banking", "defi",
  ...
  // Enterprise and B2B
  ENTERPRISE: [
    "enterprise", "b2b", "saas", "crm", "erp", "hrm",
  ...
  MOBILE: [
    ...
    "swift", "kotlin", "mobile app", "app development",
    "cross-platform", "pwa", "responsive"
  ],
  
  // Open Source
  OPEN_SOURCE: [
    "open source", "oss", "github", "gitlab", "git",
    "contributing", "pull request", "fork", "repository",
    "mit license", "apache license", "gpl", "community"
  ],
  
  // Security
  SECURITY: [
    "security", "cybersecurity", "encryption", "authentication",
    "authorization", "oauth", "jwt", "ssl", "tls", "https",
  ...
  DATA_SCIENCE: [
    ...
    "etl", "data pipeline", "visualization", "dashboard",
    "business intelligence", "bi", "reporting", "metrics"
  ],
  
  // Robotics and IoT
  ROBOTICS_IOT: [
    "robotics", "iot", "internet of things", "embedded systems",
  ...
  TRANSPORTATION: [
    "transportation", "logistics", "delivery", "shipping",
    "autonomous vehicles", "electric vehicles", "ev",
    "mobility", "rideshare", "fleet management", "supply chain"
  ],
  
  // Healthcare and Biotech
  HEALTHCARE: [
    "healthcare", "health tech", "medical", "biotech",
    "telemedicine", "digital health", "wellness", "fitness",
    "pharmaceutical", "clinical", "patient care"
  ],
  
  // Education
  EDUCATION: [
    "education", "edtech", "e-learning", "online learning",
    "course", "tutorial", "training", "certification",
    "lms", "mooc", "educational"
  ]
};
