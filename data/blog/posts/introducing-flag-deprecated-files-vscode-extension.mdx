---
title: "Introducing Flag Deprecated Files: A Simple VSCode Extension for Cleaner Codebases"
...
coverImage: "/images/posts/example-of-deprecation-flag-in-vscode.png"
readingTime: 4
---

Keeping track of deprecated files is a hassle. I hate the deja vu: "wait, didn't we mark this file as deprecated three months ago?" 🤔
...
I'd love to hear any suggestions for improvements! While it's a simple tool solving a specific need, I'd be happy to add features.
