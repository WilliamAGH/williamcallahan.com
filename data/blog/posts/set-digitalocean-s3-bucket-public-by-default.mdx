...
<BackgroundInfo title="What This Post Covers">
  <div>This guide covers:</div>
  <ul>
    <li>
      Why <a href="https://docs.digitalocean.com/products/spaces/how-to/manage-access/">limited (per-bucket) access keys</a> cause{" "}
      <code>403 Forbidden</code> on bucket-level operations.
    </li>
    <li>
      Two ways to make objects public by default: <code>--acl-public</code> via{" "}
      <a href="https://docs.digitalocean.com/products/spaces/reference/s3cmd/">s3cmd</a> and a JSON{" "}
      <a href="https://docs.digitalocean.com/products/spaces/how-to/manage-access/#bucket-policies">bucket policy</a>.
    </li>
    <li>
      How to enable <a href="https://docs.digitalocean.com/products/spaces/how-to/configure-access-logs/">Spaces access logs</a> through the S3-compatible API.
    </li>
  </ul>
</BackgroundInfo>
