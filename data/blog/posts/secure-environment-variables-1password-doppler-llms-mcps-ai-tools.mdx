...
<CollapseDropdown summary="Security boundary diagram">
...
<CollapseDropdown summary="1Password Setup and MCP Configuration">
...
4. Wrapper and IDE config

1Password needs a wrapper to refresh auth periodically. Create `~/bin/op-mcp-wrapper`:
...
Securing your AI tool credentials doesn't have to be complicated. With 1Password CLI or Doppler, you can:
...
For most individual developers, 1Password is the most convenient choice. For teams, Doppler's purpose-built design makes it the clear winner.
