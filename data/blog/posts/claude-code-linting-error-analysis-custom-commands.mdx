...
<BackgroundInfo title="Intro to Claude Code in Your CLI">
  Claude Code's built-in **/analyze** plus custom slash commands like **/project:lint** can do
  things like static analysis, error tracing, and other project-specific helpers directly in an
  agentic environment.
</BackgroundInfo>
