...
**Claude Opus 4** is Anthropic's most intelligent model to date and, according to their benchmarks, the world's best coding model. My experience anecdotally more or less confirms this, although Google and OpenAI models have recently come neck-and-neck with Anthropics.
    ...
    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
      <thead>
        <tr className="bg-gray-50/80 dark:bg-gray-800/80">
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Benchmark</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Claude Opus 4</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Claude Sonnet 4</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Previous Best</th>
        </tr>
      </thead>
      <tbody>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">SWE-bench Verified</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">72.5%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">72.7%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">67.0% (GPT-4.1)</td>
        </tr>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">Terminal-bench</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">43.2%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">39.6%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">38.0% (GPT-4.1)</td>
        </tr>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">MMLU</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">90.2%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">88.0%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">88.7% (GPT-4.1)</td>
        </tr>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">TAU-bench</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">83.0%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">78.0%</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">76.0% (o3)</td>
        </tr>
      </tbody>
    </table>
  </div>
...
<div className="my-8 overflow-hidden rounded-xl bg-white/50 dark:bg-gray-800/50 shadow-xl ring-1 ring-black/5 dark:ring-white/5">
  <div className="overflow-x-auto">
    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
      <thead>
        <tr className="bg-gray-50/80 dark:bg-gray-800/80">
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Model</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Input Tokens</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Output Tokens</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Context Window</th>
          <th scope="col" className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-600 dark:text-gray-300">Availability</th>
        </tr>
      </thead>
      <tbody>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">Claude Opus 4</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">$15 per million</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">$75 per million</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">200K tokens</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">Pro, Max, Team, Enterprise</td>
        </tr>
        <tr className="transition-colors hover:bg-gray-50/50 dark:hover:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">Claude Sonnet 4</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">$3 per million</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">$15 per million</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">200K tokens</td>
          <td className="px-6 py-4 text-sm font-medium text-left text-gray-600 dark:text-gray-300">All users (including free)</td>
        </tr>
      </tbody>
    </table>
  </div>
