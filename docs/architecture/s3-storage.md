...
| `S3_SERVER_URL`                                                  | Optional for Spaces; required only when constructing or validating direct S3 URLs. Without it, `cdn-utils` throws when attempting to build direct S3 URLs. |
