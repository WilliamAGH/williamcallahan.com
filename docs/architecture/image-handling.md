...
| Blocklists & retry queues | `LOGO_BLOCKLIST_STORE_KEY`, `S3Operations` upload retry queue (`s3-operations.ts`) | Prevent repeated failures and ensure eventual persistence.                  |
