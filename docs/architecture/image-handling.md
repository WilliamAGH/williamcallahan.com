...
| Logo blocklist & storage retry contract | `LOGO_BLOCKLIST_STORE_KEY`; [S3 retry scope and durability](./s3-storage.md#retry-scope-and-durability) | Suppress repeated logo-fetch attempts; defer storage retry semantics to the canonical S3 contract. |
