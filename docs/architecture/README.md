...
| `caching`                      | Implement high-performance, multi-tiered caching with request coalescing, cache invalidation, and memory-safe operations.                                                | [caching.md](caching.md)                                | [Diagram](caching.mmd)                       |
