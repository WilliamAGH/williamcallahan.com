...
| `macos-gui`                    | Encompass components that emulate the macOS operating system's graphical user interface style.                                                                           | [macos-gui.md](../features/macos-gui.md)                | [Diagram](../features/macos-gui.mmd)         |
