...
- AI analysis latest/history reads and writes are PostgreSQL-backed through `ai_analysis_latest` and `ai_analysis_versions`; S3 is not part of the runtime analysis cache path.
