...
This repository previously used Chroma as a derived vector index for semantic features. Chroma has been removed; semantic features for thoughts are currently disabled pending a PostgreSQL pgvector-based replacement.
