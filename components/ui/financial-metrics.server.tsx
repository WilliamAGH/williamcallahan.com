 ...
 */
export default function FinancialMetrics({ holding_return }: FinancialMetricsProps): JSX.Element {
  ...
  return (
    <div className="flex flex-wrap gap-4">
      <div className="flex flex-col">
        ...
        <span className={cn("font-medium", returnColor)}>{formatPercentage(returnValue)}</span>
      </div>
    </div>
  );
}
