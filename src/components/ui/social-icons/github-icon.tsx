...
export const GitHub = forwardRef<SVGSVGElement, LucideProps>(function GitHub(props, ref) {
  return (
    ...
    >
      <title>GitHub</title>
      {/* Optical centering/size: GitHub’s glyph is narrower than X/LinkedIn, so it can look “farther away”.
          Slightly scale it up while keeping the 24×24 viewBox and layout stable. */}
