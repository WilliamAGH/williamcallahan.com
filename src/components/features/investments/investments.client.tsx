        ...
        {!investments?.length ? (
          ...
          <>
            ...
            <div className="prose dark:prose-invert max-w-none mb-8">
              ...
              <p>
                The longer-term goal of this dataset is to shed light on early stage investing to
                make it better for everyone involved. To bring some of the rigor of public markets
                with the{" "}
                ...
                <ol className="list-decimal list-outside space-y-4 ml-4 mt-4">
                  <li className="space-y-2">
                    <p className="italic">
                      ...
                      and at some later point, either when you exit or at an arbitrary point in
                      time. Exits are easy to calculate (the price is set by someone else, just as
                      the investment had), but the majority of current investments otherwise must be
                    ...
                    <p className="italic">
                      ...
                      Remember, this is not an endorsement or investment advice, nor an offer for
                      any securities.
                    </p>
                  </li>
                  <li className="space-y-2">
                    ...
                    <p className="italic">
                      ...
                      the principal ends up getting invested in the company. Therefore it
                      immediately has a negative return equal to the amount of transaction expense
                      incurred. And in the event of a total loss without a distribution, it has been
                      accounted for as a total loss of the principal invested excluding the
                      transaction costs.
                    </p>
                  </li>
                </ol>
